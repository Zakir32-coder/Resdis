...
const StudentAdmissionForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        registrationNo: "", previousInstitution: "", campusId: "", shiftId: "",
    ...
    const gridColsClass = visibleFieldCount > 3 ? 'md:grid-cols-3' : 'md:grid-cols-2';
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex justify-center py-10 px-4">
            ...
            >
                ...
                <section className="p-5 bg-indigo-50 rounded-lg border border-indigo-200">
                    ...
                    {showAcademicMore && (
                        <div className={`grid ${gridColsClass} gap-5 mt-4 pt-4 border-t border-indigo-100`}>
                ...
                <section className="p-5 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                        ...
                        <FormInput label="Student Name" id="studentName" required>
                            <input type="text" name="studentName" placeholder="Full Name" value={formData.studentName} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                        </FormInput>
                        <FormInput label="Gender" id="gender" required>
                            <select name="gender" value={formData.gender} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500">
                        ...
                        <FormInput label="Date of Birth" id="dob" required>
                            <input type="date" name="dob" value={formData.dob} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                        </FormInput>
                        <FormInput label="Father's Name" id="fatherName" required>
                            <input type="text" name="fatherName" placeholder="Father name" value={formData.fatherName} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                        </FormInput>
                        <FormInput label="Mother's Name" id="motherName" required>
                            <input type="text" name="motherName" placeholder="Mother name" value={formData.motherName} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                        </FormInput>
                    </div>
                    ...
                    {showPersonalMore && (
                        <div className="grid md:grid-cols-2 gap-5 mt-4 pt-4 border-t border-blue-100">
                             <FormInput label="Religion" id="religion">
                                <input type="text" name="religion" placeholder="Religion" value={formData.religion} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Nationality" id="nationality">
                                <input type="text" name="nationality" value={formData.nationality} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Birth Cert/NID/Passport No." id="idNumber">
                                <input type="text" name="idNumber" value={formData.idNumber} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Father NID" id="fatherNid">
                                <input type="text" name="fatherNid" value={formData.fatherNid} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Mother NID" id="motherNid">
                                <input type="text" name="motherNid" value={formData.motherNid} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Blood Group" id="bloodGroup">
                                <select name="bloodGroup" value={formData.bloodGroup} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500">
                ...
                <section className="p-5 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                       <FormInput label="Emergency Contact Phone" id="emergencyContact" required>
                            <input type="tel" name="emergencyContact" value={formData.emergencyContact} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                        </FormInput>
                       <div className="md:col-span-2">
                           <FormInput label="Present Address" id="address" required>
                                <textarea name="address" rows="3" placeholder="Full address" value={formData.address} onChange={handleChange} required className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500"></textarea>
                            </FormInput>
                       </div>
                    </div>
                    ...
                    {showAddressMore && (
                        <div className="grid md:grid-cols-2 gap-5 mt-4 pt-4 border-t border-green-100">
                           <FormInput label="Primary Phone" id="primaryPhone">
                                <input type="tel" name="primaryPhone" value={formData.primaryPhone} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                           <FormInput label="Guardian Name" id="guardianName">
                                <input type="text" name="guardianName" value={formData.guardianName} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                           <FormInput label="Guardian Relationship" id="guardianRelationship">
                                <input type="text" name="guardianRelationship" value={formData.guardianRelationship} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                            <FormInput label="Guardian Contact" id="guardianContact">
                                <input type="tel" name="guardianContact" value={formData.guardianContact} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500" />
                            </FormInput>
                        </div>
                    )}
                </section>
